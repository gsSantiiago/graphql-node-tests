...
export const commentResolvers = {
    ...
    Comment: {
        ...
        user: (comment, args, {db, dataLoader: {userLoader}}: {db: DbConnection, dataLoader: DataLoaders}, info: GraphQLResolveInfo) => {
            return userLoader
                .load({key: comment.get('user'), info})
                .catch(handleError);
        },

        post: (comment, args, {db, dataLoader: {postLoader}}: {db: DbConnection, dataLoader: DataLoaders}, info: GraphQLResolveInfo) => {
            return postLoader
